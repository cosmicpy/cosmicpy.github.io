...
CosmicPy is hosted on a public GitHub repository at this address: https://git.orioncloud.fr/work/cosmicpy

The package can be retrieved with the following command::
    
    $ git clone https://git.orioncloud.fr/work/cosmicpy.git

This will clone the latest release of the code into a local folder **cosmicpy.git**.
